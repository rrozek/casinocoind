...
class basic_multi_buffer<Allocator>::const_buffers_type
{
    ...
    explicit const_buffers_type(basic_multi_buffer const &b);
...
class basic_multi_buffer<Allocator>::mutable_buffers_type
{
    ...
    explicit mutable_buffers_type(basic_multi_buffer const &b);
...
class basic_multi_buffer<Allocator>::mutable_buffers_type::const_iterator
{
  ...
  public:
    ...
    operator*() const
    {
        auto const &e = *it_;
        return value_type{e.data(),
                          &e == &*std::prev(b_->list_.end()) ? b_->out_end_ : e.size()} +
...
basic_multi_buffer<Allocator>::
    ...
    : detail::empty_base_optimization<allocator_type>(
      ...
      max_(other.max_), in_size_(other.in_size_), in_pos_(other.in_pos_), out_pos_(other.out_pos_), out_end_(other.out_end_)
{
    auto const at_end =
...
basic_multi_buffer<Allocator>::
    basic_multi_buffer(basic_multi_buffer const &other,
                       Allocator const &alloc)
    : detail::empty_base_optimization<allocator_type>(alloc), max_(other.max_), out_(list_.end())
{
    copy_from(other);
}
...
template <class Allocator>
auto basic_multi_buffer<Allocator>::
operator=(basic_multi_buffer &&other) -> basic_multi_buffer &
{
    if (this == &other)
        return *this;
    reset();
...
template <class Allocator>
auto basic_multi_buffer<Allocator>::
operator=(basic_multi_buffer const &other) -> basic_multi_buffer &
{
    if (this == &other)
        return *this;
    copy_assign(other, typename alloc_traits::propagate_on_container_copy_assignment{});
    return *this;
}
...
template <class Allocator>
auto basic_multi_buffer<Allocator>::
    prepare(size_type n) -> mutable_buffers_type
{
    if (in_size_ + n > max_)
