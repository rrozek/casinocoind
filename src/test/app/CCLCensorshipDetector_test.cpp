...
class CCLCensorshipDetector_test : public beast::unit_test::suite
{
    void test(
        CCLCensorshipDetector<int, int>& cdet, int round,
        ...
        std::vector<int> remain, std::vector<int> remove)
    {
        ...
        CCLCensorshipDetector<int, int>::TxIDSeqVec proposal;
...
public:
    ...
    run() override
    {
        ...
        CCLCensorshipDetector<int, int> cdet;
        int round = 0;
