...
public:
    ...
    test_convert_all_of_an_asset(FeatureBitset features)
    {
...

        {
            ...
            env(pay("alice", "bob", USD(10)), delivermin(CSC(5)),
                txflags(tfPartialPayment),                          ter(temBAD_AMOUNT));
...

        {
            ...
            env(pay("alice", "alice", USD(10000)), paths(CSC),
...

        {
            ...
            env(offer("bob", CSC(100), USD(100)));
            env(offer("bob", CSC(1000), USD(100)));
            env(offer("bob", CSC(10000), USD(100)));
            env(pay("alice", "carol", USD(10000)), paths(CSC),
                delivermin(USD(200)), txflags(tfPartialPayment),
                sendmax(CSC(1000)),                                 ter(tecPATH_PARTIAL));
            env(pay("alice", "carol", USD(10000)), paths(CSC),
                delivermin(USD(200)), txflags(tfPartialPayment),
                sendmax(CSC(1100)));
