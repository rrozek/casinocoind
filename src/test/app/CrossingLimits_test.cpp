...
public:
    ...
    testCrossingLimit(FeatureBitset features)
    {
        ...
        n_offers (env, 1000, "bob", CSC(1), USD(1));

        // Alice offers to buy 1000 CSC for 1000 USD. She takes the first
        ...
        // Carol offers to buy 1000 CSC for 1000 USD. She takes the remaining
    ...
    testStepAndCrossingLimit(FeatureBitset features)
    {
        ...
        n_offers (env, 700, "carol", CSC(1), USD(1));
        n_offers (env, 999, "evita", CSC(1), USD(1));
        ...
        // Dan offers to buy 900 CSC for 900 USD. He removes all 100 of Carol's
        // offers as unfunded, then takes 850 USD from Evita's, hitting the
        // crossing limit.
        env(offer("dan", USD(900), CSC(900)));
