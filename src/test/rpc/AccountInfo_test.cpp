   ...
   void testSignerListsV2()
    {
        ...
        // Alice has no SignerList yet.
        {
            ...
            BEAST_EXPECT(info.isMember(jss::casinocoinrpc) && info[jss::casinocoinrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(info[0u].isMember(jss::casinocoinrpc) && info[0u][jss::casinocoinrpc] == "2.0");
            ...
            BEAST_EXPECT(info[1u].isMember(jss::casinocoinrpc) && info[1u][jss::casinocoinrpc] == "2.0");
