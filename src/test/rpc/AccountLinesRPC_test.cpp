...
public:
    void testAccountLines()
    {
        ...
        for (char c = 0; c <= ('Z' - 'A'); ++c)
        {
            ...
            env(trust(alice, gw2Currency(0), gw2, tfSetNoCasinocoin | tfSetFreeze));
        }
        env.close();
    ...
    void testAccountLineDelete()
    {
        ...
        Account const gw1 {"gw1"};
        Account const gw2 {"gw2"};
        env.fund(CSC(10000), alice, becky, cheri, gw1, gw2);
        env.close();
    ...
    void testAccountLines2()
    {
        ...
        [this, &env](Account const& account, LedgerInfo const& info, int count)
        {
            ...
            BEAST_EXPECT(linesSeq.isMember(jss::casinocoinrpc) && linesSeq[jss::casinocoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesHash.isMember(jss::casinocoinrpc) && linesHash[jss::casinocoinrpc] == "2.0");
        ...
        }
        {
            ...
            BEAST_EXPECT(linesA.isMember(jss::casinocoinrpc) && linesA[jss::casinocoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesB.isMember(jss::casinocoinrpc) && linesB[jss::casinocoinrpc] == "2.0");
            ...
            BEAST_EXPECT(linesC.isMember(jss::casinocoinrpc) && linesC[jss::casinocoinrpc] == "2.0");
