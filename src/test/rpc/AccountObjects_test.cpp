...
public:
       ...
       // test errors on marker
        {
            ...
            env(pay(gw, bob, CSC(1)));
            env(offer(bob, CSC(100), bob["USD"](1)), txflags(tfPassive));
    ...
    void testUnsteppedThenStepped()
    {
        ...
        env(offer(bob, CSC(100), bob["USD"](1)),txflags(tfPassive));
        env(offer(bob, CSC(100), USD1(1)), txflags(tfPassive));
    ...
    void testObjectTypes()
    {
        ...
        }
        {
            ...
            jvEscrow[jss::Amount] = CSC(100).value().getJson(0);
        ...
        }
        {
            ...
            jvPayChan[jss::Amount] = CSC (300).value().getJson (0);
