...
{ "Cannot create CSC to CSC paths.",
R"({
    "command": "doesnt_matter",
    "account": "cHb9CJAWyB4cj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
R"({
    ...
    "tx_json": {
        ...
        "Amount": {
            "value": "10",
            "currency": "USD",
            "issuer": "cLPwWB1itaUGMV8kbMLLysjGkEpTM2Soy4"
        },
        "Destination": "cnUy2SHTcB9DubsPmkJZUXTf5FrNDGcYEA",
        "TransactionType": "Payment"
    }
...
{ "Even though 'Amount' may not be CSC for pathfinding, 'SendMax' may be CSC.",
R"({
    "command": "doesnt_matter",
    "account": "cHb9CJAWyB4cj91VRWn96DkukG4bwdtyTh",
    "secret": "masterpassphrase",
...
R"({
    "command": "doesnt_matter",
    "account": "cJcxi4Wxev4bnAGVNP9YCdKPdAoKfAmrsi",
    "key_type": "ed25519",
...
public:
    ...
    {
        testcase ("testAutoFillEscalatedFees");
        ...
        // jrojek Disabled due to no fee escalation and queue management
//        {
...
//        }
    ...
    {
        testcase ("testTransactionRPC");
        using namespace std::chrono_literals;
        // Use jtx to set up a ledger so the tests will do the right thing.
        test::jtx::Account const a {"a"}; // cnUy2SHTcB9DubsPmkJZUXTf5FrNDGcYEA
        test::jtx::Account const g {"g"}; // cLPwWB1itaUGMV8kbMLLysjGkEpTM2Soy4
        auto const USD = g["USD"];

        // Account: cJcxi4Wxev4bnAGVNP9YCdKPdAoKfAmrsi
        // seed:    sh1yJfwoi98zCygwijUzuHmJDeVKd
        test::jtx::Account const ed {"ed", KeyType::ed25519}; //
        // master is cHb9CJAWyB4cj91VRWn96DkukG4bwdtyTh.
        // "b" (not in the ledger) is cDg53Haik2475DJx8bjMDSDPj4VX7htaMd.
        // "c" (phantom signer) is cPrNzota6B8YBokhYtrTNqQVCngtbnWfux.
        ...
        using TestStuff =
            std::tuple <signFunc, submitFunc, char const*, unsigned int, unsigned int>;

        static TestStuff const testFuncs [] =
        {
            TestStuff {transactionSign, nullptr,              "sign",               0, 4},
            TestStuff {nullptr, transactionSubmit,            "submit",             1, 4},
            TestStuff {transactionSignFor, nullptr,           "sign_for",           2, 4},
            TestStuff {nullptr, transactionSubmitMultiSigned, "submit_multisigned", 3, 4}
        };
...
BEAST_DEFINE_TESTSUITE(JSONRPC,casinocoin_app,casinocoin);
