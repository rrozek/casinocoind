...
class LedgerRPC_test : public beast::unit_test::suite
{
    ...
    // '!' is not part of the casinocoin alphabet.
    std::string
    ...
    void testLedgerEntryCheck()
    {
        ...
        env (checkCreate (env.master, alice, CSC(100)));
        env.close();
    ...
    void testLedgerEntryEscrow()
    {
        ...
        std::string escrowIndex;
        {
            ...
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
                jrr[jss::node][jss::Amount] == CSC(333).value().getText());
    ...
    void testLedgerEntryOffer()
    {
        ...
        env (offer (alice, USD (321), CSC (322)));
        env.close();
    ...
    void testLedgerEntryPayChan()
    {
        ...
        env (payChanCreate (alice, env.master, CSC(57), 18s, alice.pk()));
        env.close();
    ...
    void testLedgerEntryCasinocoinState()
    {
        testcase ("ledger_entry Request CasinocoinState");
        using namespace test::jtx;
        Env env {*this};
        Account const alice {"alice"};
        Account const gw { "gateway" };
        ...
        std::string const ledgerHash {to_string (env.closed()->info().hash)};
        {
            ...
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::casinocoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::casinocoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            BEAST_EXPECT(
        ...
        {
            // casinocoin_state is not an object.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = "casinocoin_state";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
            checkErrorValue (jrr, "malformedRequest", "");
        ...
        {
            // casinocoin_state.currency is missing.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
        ...
        {
            // casinocoin_state accounts is not an array.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = 2;
            jvParams[jss::casinocoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // casinocoin_state one of the accounts is missing.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
        ...
        {
            // casinocoin_state more than 2 accounts.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::casinocoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::casinocoin_state][jss::accounts][2u] = alice.human();
            jvParams[jss::casinocoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // casinocoin_state account[0] is not a string.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = 44;
            jvParams[jss::casinocoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::casinocoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
        ...
        {
            // casinocoin_state account[1] is not a string.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::casinocoin_state][jss::accounts][1u] = 21;
            jvParams[jss::casinocoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // casinocoin_state account[0] == account[1].
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::casinocoin_state][jss::accounts][1u] = alice.human();
            jvParams[jss::casinocoin_state][jss::currency] = "USD";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
        ...
        {
            // casinocoin_state malformed account[0].
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] =
        ...
        {
            // casinocoin_state malformed account[1].
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::casinocoin_state][jss::accounts][1u] =
        ...
        {
            // casinocoin_state malformed currency.
            Json::Value jvParams;
            jvParams[jss::casinocoin_state] = Json::objectValue;
            jvParams[jss::casinocoin_state][jss::accounts] = Json::arrayValue;
            jvParams[jss::casinocoin_state][jss::accounts][0u] = alice.human();
            jvParams[jss::casinocoin_state][jss::accounts][1u] = gw.human();
            jvParams[jss::casinocoin_state][jss::currency] = "USDollars";
            jvParams[jss::ledger_hash] = ledgerHash;
            Json::Value const jrr = env.rpc (
                "json", "ledger_entry", to_string (jvParams))[jss::result];
    ...
    void testLookupLedger()
    {
        ...
        env.fund(CSC(10000), "alice");
        env.close();
        env.fund(CSC(10000), "bob");
        env.close();
        env.fund(CSC(10000), "jim");
        env.close();
        env.fund(CSC(10000), "jill");
    ...
    void testQueue()
    {
        ...
        env.fund(CSC(10000), bob);
        env.close();
        env.fund(CSC(10000), charlie);
        env.fund(CSC(10000), daria);
        env.close();
        ...
        env(pay(alice, "george", CSC(1000)), json(R"({"LastLedgerSequence":7})"),
            ter(terQUEUED));
        env(offer(alice, CSC(50000), alice["USD"](5000)), seq(aliceSeq + 1),
            ter(terQUEUED));
