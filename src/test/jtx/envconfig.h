...
#ifndef CASINOCOIN_TEST_JTX_ENVCONFIG_H_INCLUDED
#define CASINOCOIN_TEST_JTX_ENVCONFIG_H_INCLUDED
...
/// casinocoin::Config. The function takes ownership of the unique_ptr and
