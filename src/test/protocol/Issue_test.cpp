...
#ifndef CASINOCOIN_ASSETS_ENABLE_STD_HASH
# if BEAST_MAC || BEAST_IOS
#  define CASINOCOIN_ASSETS_ENABLE_STD_HASH 0
# else
#  define CASINOCOIN_ASSETS_ENABLE_STD_HASH 1
# endif
#endif
...
#if CASINOCOIN_ASSETS_ENABLE_STD_HASH
