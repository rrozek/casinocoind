...
#ifndef CASINOCOIN_RESOURCE_ENTRY_H_INCLUDED
#define CASINOCOIN_RESOURCE_ENTRY_H_INCLUDED

#include <casinocoin/basics/DecayingSample.h>
...
#include <casinocoin/beast/core/List.h>
#include <cassert>
