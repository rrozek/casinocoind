...
#ifndef CASINOCOIN_RESOURCE_LOGIC_H_INCLUDED
#define CASINOCOIN_RESOURCE_LOGIC_H_INCLUDED

#include <casinocoin/resource/Fees.h>
#include <casinocoin/resource/Gossip.h>
#include <casinocoin/resource/impl/Import.h>
