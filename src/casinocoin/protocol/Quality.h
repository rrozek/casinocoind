...
#ifndef CASINOCOIN_PROTOCOL_QUALITY_H_INCLUDED
#define CASINOCOIN_PROTOCOL_QUALITY_H_INCLUDED
...
// Casinocoin specific constant used for parsing qualities and other things
...
public:
    ...
    */
    ...
    ceil_in (TAmounts<In, Out> const& amount, In const& limit) const
    {
        ...
        // replacing with code specific to IOUAMount and CSCAmount
