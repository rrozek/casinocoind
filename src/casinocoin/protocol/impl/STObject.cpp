...
bool STObject::set (SerialIter& sit, int depth) noexcept (false)
{
    ...
    auto const sf = getSortedFields(*this, SField::WhichFields::includeAll);
...
bool STObject::isEquivalent (const STBase& t) const
{
    ...
    auto const sf1 = getSortedFields(*this, SField::WhichFields::includeAll);
    auto const sf2 = getSortedFields(*v, SField::WhichFields::includeAll);
...
void STObject::add (Serializer& s, SField::WhichFields whichFields) const
{
...
STObject::getSortedFields (
    STObject const& objToSort, SField::WhichFields whichFields)
{
