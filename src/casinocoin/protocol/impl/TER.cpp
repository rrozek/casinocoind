...
transResults()
{
    ...
    results
    {
        ...
        { tecNO_DST,                 { "tecNO_DST",                "Destination does not exist. Send CSC to create it."                            } },
        { tecNO_DST_INSUF_CSC,       { "tecNO_DST_INSUF_CSC",      "Destination does not exist. Too little CSC sent to create it."                 } },
        ...
        { tecUNFUNDED_ADD,           { "tecUNFUNDED_ADD",          "Insufficient CSC balance for WalletAdd."                                       } },
        { tecUNFUNDED_OFFER,         { "tecUNFUNDED_OFFER",        "Insufficient balance to fund created offer."                                   } },
        { tecUNFUNDED_PAYMENT,       { "tecUNFUNDED_PAYMENT",      "Insufficient CSC balance to send."                                             } },
        ...
        { tefNOT_WLT,                { "tefNOT_WLT",               "Involved token is not White Labeled Token."                                    } },
        ...
        { temBAD_FEE,                { "temBAD_FEE",               "Invalid fee, negative or not CSC."                                             } },
        ...
        { temBAD_SEND_CSC_PARTIAL,   { "temBAD_SEND_CSC_PARTIAL",  "Malformed: Partial payment is not allowed for CSC to CSC."                     } },
        { temBAD_SEND_CSC_PATHS,     { "temBAD_SEND_CSC_PATHS",    "Malformed: Paths are not allowed for CSC to CSC."                              } },
        ...
        { temCASINOCOIN_EMPTY,           { "temCASINOCOIN_EMPTY",          "PathSet with no paths."                                                } },
        ...
        { terNO_CASINOCOIN,              { "terNO_CASINOCOIN",             "Path does not permit rippling."                                        } },
        { terNO_ACCOUNT,             { "terNO_ACCOUNT",            "The source account does not exist."                                            } },
        { terNO_AUTH,                { "terNO_AUTH",               "Not authorized to hold IOUs."                                                  } },
        { terNO_LINE,                { "terNO_LINE",               "No such line."                                                                 } },
        { terPRE_SEQ,                { "terPRE_SEQ",               "Missing/inapplicable prior transaction."                                       } },
        { terOWNERS,                 { "terOWNERS",                "Non-zero owner count."                                                         } },
        { terQUEUED,                 { "terQUEUED",                "Consensus is busy. Transaction held in queue."                                 } },
