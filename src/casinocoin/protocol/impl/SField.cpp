...
SF_U32 const sfKYCTime           (access, STI_UINT32, 15, "Date");
...
SF_U32 const sfConfigID            (access, STI_UINT32, 40, "SignerListID");
SF_U32 const sfConfigType          (access, STI_UINT32, 41, "SettleDelay");
...
SF_U64 const sfIssuerNode       (access, STI_UINT64, 11,"IssuerNode");
...
SF_Amount const sfCasinocoinEscrow    (access, STI_AMOUNT, 17, "CasinocoinEscrow");
...
SF_Blob const sfClientIP        (access, STI_VL, 15, "ClientIP", SField::sMD_Default, SField::notSigningNotHashed);
...
SF_Blob const sfConfigData      (access, STI_VL, 19, "ConfigData");
...
SF_Vec256 const sfConfigHashes (access, STI_VECTOR256, 4, "ConfigHashes");

SF_Vec128 const sfKYCVerifications (access, STI_VECTOR128, 1, "Verifications");
...
SField const sfKYC                 (access, STI_OBJECT, 19, "KYC");
SField const sfConfigEntry         (access, STI_OBJECT, 20, "ConfigEntry");
