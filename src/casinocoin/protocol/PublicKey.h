...
#ifndef CASINOCOIN_PROTOCOL_PUBLICKEY_H_INCLUDED
#define CASINOCOIN_PROTOCOL_PUBLICKEY_H_INCLUDED

#include <casinocoin/basics/Slice.h>
#include <casinocoin/crypto/KeyType.h> // move to protocol/
...
/** A public key.
    ...
    The format of the public key is Casinocoin specific,
