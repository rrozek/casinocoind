...
#ifndef CASINOCOIN_PROTOCOL_ISSUE_H_INCLUDED
#define CASINOCOIN_PROTOCOL_ISSUE_H_INCLUDED
...
/** Returns an asset specifier that represents CSC. */
inline Issue const& cscIssue ()
{
    static Issue issue {cscCurrency(), cscAccount()};
    return issue;
}
