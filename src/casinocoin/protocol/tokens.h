...
#ifndef CASINOCOIN_PROTOCOL_TOKENS_H_INCLUDED
#define CASINOCOIN_PROTOCOL_TOKENS_H_INCLUDED
...
// Facilities for converting Casinocoin tokens
// to and from their human readable strings

/*  Base-58 encode a Casinocoin Token

    Casinocoin Tokens have a one-byte prefx indicating
