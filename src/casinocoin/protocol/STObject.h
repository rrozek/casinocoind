...
#ifndef CASINOCOIN_PROTOCOL_STOBJECT_H_INCLUDED
#define CASINOCOIN_PROTOCOL_STOBJECT_H_INCLUDED
...
private:
    void add (Serializer & s, SField::WhichFields whichFields) const;
