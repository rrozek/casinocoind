...
#ifndef CASINOCOIN_PROTOCOL_DIGEST_H_INCLUDED
#define CASINOCOIN_PROTOCOL_DIGEST_H_INCLUDED

#include <casinocoin/basics/base_uint.h>
#include <casinocoin/beast/crypto/ripemd.h>
#include <casinocoin/beast/crypto/sha2.h>
...
/*  Message digest functions used in the Casinocoin Protocol
...
/** Returns the RIPEMD-160 digest of the SHA256 hash of the message.
    ...
    representing a Casinocoin account, from a message. Typically the
