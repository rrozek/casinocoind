...
#ifndef CASINOCOIN_PROTOCOL_STACCOUNT_H_INCLUDED
#define CASINOCOIN_PROTOCOL_STACCOUNT_H_INCLUDED
...
private:
    ...
    // overhead in a casinocoin::uint160.  However, so the serialized format of the
