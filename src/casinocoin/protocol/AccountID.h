...
#ifndef CASINOCOIN_PROTOCOL_ACCOUNTID_H_INCLUDED
#define CASINOCOIN_PROTOCOL_ACCOUNTID_H_INCLUDED
...
/** A special account that's used as the "issuer" for CSC. */
AccountID const&
cscAccount();
...
/** Caches the base58 representations of AccountIDs
    ...
    justify having a cache. In the future, casinocoind should
...
public:
    ...
    /** Return casinocoin::toBase58 for the AccountID
