...
#ifndef CASINOCOIN_PROTOCOL_HASHPREFIX_H_INCLUDED
#define CASINOCOIN_PROTOCOL_HASHPREFIX_H_INCLUDED
...
/** Prefix for hashing functions.
    ...
    @note Hash prefixes are part of the Casinocoin protocol.
