...
#ifndef CASINOCOIN_NODESTORE_DATABASEIMP_H_INCLUDED
#define CASINOCOIN_NODESTORE_DATABASEIMP_H_INCLUDED
...
#include <casinocoin/basics/KeyCache.h>
...
public:
    ...
    void storeInternal (NodeObjectType type,
                        ...
                        Backend& backend)
    {
        #if CASINOCOIN_VERIFY_NODEOBJECT_KEYS
