...
#ifndef CASINOCOIN_NODESTORE_DATABASESHARDIMP_H_INCLUDED
#define CASINOCOIN_NODESTORE_DATABASESHARDIMP_H_INCLUDED

#include <casinocoin/nodestore/DatabaseShard.h>
#include <casinocoin/nodestore/impl/Shard.h>
