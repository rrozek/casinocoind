...
#ifndef CASINOCOIN_JSON_WRITER_H_INCLUDED
#define CASINOCOIN_JSON_WRITER_H_INCLUDED

#include <casinocoin/basics/contract.h>
#include <casinocoin/basics/ToString.h>
...
{
    if (! condition)
        casinocoin::Throw<std::logic_error> (message);
}
