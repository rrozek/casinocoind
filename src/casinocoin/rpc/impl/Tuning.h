...
#ifndef CASINOCOIN_RPC_TUNING_H_INCLUDED
#define CASINOCOIN_RPC_TUNING_H_INCLUDED
...
// jrojek 18.06.2019 Token extraFee can increase necessary fee significantly
static int const defaultAutoFillFeeMultiplier = 100000;
...
auto constexpr maxValidatedLedgerAge = 30min;
