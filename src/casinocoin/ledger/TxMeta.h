...
#ifndef CASINOCOIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
#define CASINOCOIN_APP_TX_TRANSACTIONMETA_H_INCLUDED
...
// VFALCO Move to casinocoin/app/ledger/detail, rename to TxMeta
class TxMeta
{
public:
