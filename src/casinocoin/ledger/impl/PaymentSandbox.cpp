        ...
        STAmount const& amount) const
{
    ...
    */
    ...
    if (isCSC(issuer) && adjustedAmt < beast::zero)
        // A calculated negative CSC balance is not an error case. Consider a
        // payment snippet that credits a large CSC amount and then debits the
...
PaymentSandbox::balanceChanges (ReadView const& view) const
{
    ...
    // get the change in CSC balance, Account == root, issuer == root, currency == CSC
...
CSCAmount PaymentSandbox::cscDestroyed () const
{
