...
#ifndef CASINOCOIN_LEDGER_VIEW_H_INCLUDED
#define CASINOCOIN_LEDGER_VIEW_H_INCLUDED
...
// Return the account's liquid (not reserved) CSC.  Generally prefer
...
trustCreate (ApplyView& view,
    ...
    uint256 const&  uIndex,             // --> casinocoin state entry
    SLE::ref        sleAccount,         // --> the account being set.
    const bool      bAuth,              // --> authorize account.
    const bool      bNocasinocoin,          // --> others cannot casinocoin through
