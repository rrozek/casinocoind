...
#ifndef CASINOCOIN_LEDGER_PAYMENTSANDBOX_H_INCLUDED
#define CASINOCOIN_LEDGER_PAYMENTSANDBOX_H_INCLUDED

#include <casinocoin/ledger/RawView.h>
#include <casinocoin/ledger/Sandbox.h>
#include <casinocoin/ledger/detail/ApplyViewBase.h>
