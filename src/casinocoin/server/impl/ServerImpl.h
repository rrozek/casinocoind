...
#ifndef CASINOCOIN_SERVER_SERVERIMPL_H_INCLUDED
#define CASINOCOIN_SERVER_SERVERIMPL_H_INCLUDED

#include <casinocoin/basics/chrono.h>
#include <casinocoin/server/Server.h>
#include <casinocoin/server/impl/Door.h>
#include <casinocoin/server/impl/io_list.h>
