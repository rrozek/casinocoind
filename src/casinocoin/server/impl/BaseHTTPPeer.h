...
#ifndef CASINOCOIN_SERVER_BASEHTTPPEER_H_INCLUDED
#define CASINOCOIN_SERVER_BASEHTTPPEER_H_INCLUDED
...
#include <casinocoin/beast/asio/ssl_error.h> // for is_short_read?
