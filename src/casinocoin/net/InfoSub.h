...
#ifndef CASINOCOIN_NET_INFOSUB_H_INCLUDED
#define CASINOCOIN_NET_INFOSUB_H_INCLUDED
...
public:
    ...
    */
    ...
    public:
        ...
        virtual bool subPerformanceReports (ref ispListener) = 0;
        virtual bool unsubPerformanceReports (std::uint64_t uListener) = 0;
