...
#ifndef CASINOCOIN_UTILITY_TAGGED_INTEGER_H_INCLUDED
#define CASINOCOIN_UTILITY_TAGGED_INTEGER_H_INCLUDED
...
struct is_contiguously_hashable<casinocoin::tagged_integer<Int, Tag>, HashAlgorithm>
