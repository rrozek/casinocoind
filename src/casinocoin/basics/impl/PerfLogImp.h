...
#ifndef CASINOCOIN_BASICS_PERFLOGIMP_H
#define CASINOCOIN_BASICS_PERFLOGIMP_H
    ...
    : public PerfLog, Stoppable
{
    ...
    Counters counters_ {casinocoin::RPC::getHandlerNames(), JobTypes::instance()};
...
#endif //CASINOCOIN_BASICS_PERFLOGIMP_H
