...
#ifndef CASINOCOIN_BASICS_BYTEORDER_H_INCLUDED
#define CASINOCOIN_BASICS_BYTEORDER_H_INCLUDED
...
// VFALCO These are all deprecated please use the ones in <casinocoin/beast/core/ByteOrder.h>
