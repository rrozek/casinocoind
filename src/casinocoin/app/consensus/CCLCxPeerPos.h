...
#ifndef CASINOCOIN_APP_CONSENSUS_CCLCXPEERPOS_H_INCLUDED
#define CASINOCOIN_APP_CONSENSUS_CCLCXPEERPOS_H_INCLUDED
...
/** A peer's signed, proposed position for use in CCLConsensus.
