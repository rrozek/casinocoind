...
#ifndef CASINOCOIN_APP_CONSENSUS_RCLCENSORSHIPDETECTOR_H_INCLUDED
#define CASINOCOIN_APP_CONSENSUS_RCLCENSORSHIPDETECTOR_H_INCLUDED

#include <casinocoin/basics/algorithm.h>
