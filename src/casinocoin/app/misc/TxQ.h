...
#ifndef CASINOCOIN_TXQ_H_INCLUDED
#define CASINOCOIN_TXQ_H_INCLUDED
    ...
    */
    struct Setup
    {
        ...
        */
        ...
        std::uint64_t minimumEscalationMultiplier = baseLevel * 1;
    ...
    */
    ...
    public:
        ...
        /**
            ...
            @param timeLeap Indicates that casinocoind is under load so fees
            should grow faster.
