...
#ifndef CASINOCOIN_APP_MISC_MANIFEST_H_INCLUDED
#define CASINOCOIN_APP_MISC_MANIFEST_H_INCLUDED
...
/*
    ...
    EVERY casinocoind needs to have its config updated with the new public keys, and
    ...
    received from casinocoind peers.
    ...
    signed by the master key.  When a casinocoind peer receives the new manifest,
