...
#ifndef CASINOCOIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
#define CASINOCOIN_APP_MISC_SHAMAPSTOREIMP_H_INCLUDED
...
private:
    ...
    std::string const dbPrefix_ = "casinocoindb";
...
private:
    ...
    // If casinocoind is not healthy, defer rotate-delete.
