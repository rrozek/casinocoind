...
/** Get the current CasinocoinLineCache, updating it if necessary.
    Get the correct ledger to use.
*/
std::shared_ptr<CasinocoinLineCache>
    ...
    bool authoritative)
{
    ...
    {
        mLineCache = std::make_shared<CasinocoinLineCache> (ledger);
    }
    return mLineCache;
}
                              ...
                              Job::CancelCallback shouldCancel)
{
    ...
    std::shared_ptr<CasinocoinLineCache> cache;
...
// Make an old-style casinocoin_path_find request
Json::Value
...
PathRequests::doLegacyPathRequest (
        ...
        Json::Value const& request)
{
    auto cache = std::make_shared<CasinocoinLineCache> (inLedger);
