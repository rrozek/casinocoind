...
#ifndef CASINOCOIN_APP_PATHS_CASINOCOINCALC_H_INCLUDED
#define CASINOCOIN_APP_PATHS_CASINOCOINCALC_H_INCLUDED
...
/** CasinocoinCalc calculates the quality of a payment path.
...
private:
    ...
    TER casinocoinCalculate (detail::FlowDebugInfo* flowDebugInfo=nullptr);
