...
#ifndef CASINOCOIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
#define CASINOCOIN_APP_PATHS_CURSOR_PATHCURSOR_H_INCLUDED
...
public:
    PathCursor(
        ...
        NodeIndex nodeIndex = 0)
            : casinocoinCalc_(casinocoinCalc),
...
private:
    ...
    {
        return {casinocoinCalc_, pathState_, multiQuality_, j_, nodeIndex_ + delta};
    }
    ...
    */
    ...
    CasinocoinCalc& casinocoinCalc_;
