...
void casinocoinLiquidity (
    CasinocoinCalc& casinocoinCalc,
    ...
    std::uint64_t& uRateMax)
{
    ...
    if (qualityIn >= qualityOut)
    {
        ...
        JLOG (casinocoinCalc.j_.trace()) << "casinocoinLiquidity: No fees";
    ...
    else
    {
        ...
        JLOG (casinocoinCalc.j_.trace()) << "casinocoinLiquidity: Fee";
        ...
        if (!uRateMax || uRate <= uRateMax)
        {
            ...
            else
            {
                ...
                JLOG (casinocoinCalc.j_.trace())
                    << "casinocoinLiquidity:4: saCurReq=" << saCurReq;
...
quality_in (
    ...
    Currency const& currency)
{
    return casinocoinQuality (view, uToAccountID, uFromAccountID, currency,
