...
#ifndef CASINOCOIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
#define CASINOCOIN_APP_PATHS_IMPL_PAYSTEPS_H_INCLUDED
...
/**
   ...
   There are five concrete step classes:
     ...
     BookStepIX is an IOU/CSC offer book
     BookStepXI is an CSC/IOU offer book
     CSCEndpointStep is the source or destination account for CSC
...
public:
    ...
    */
    ...
    /**
       ...
       account. This is needed for checkNoCasinocoin.
    */
    ...
    // For CSC endpoints, one of src or dst will be the root account
...
/*
   ...
   @param path Liquidity sources to use for this strand of the payment. The path
               ...
               accounts to casinocoin through.
...
struct StrandContext
{
    ...
    /** The previous step in the strand. Needed to check the no casinocoin
        constraint
     */
