...
/**
   ...
   @param strand Steps of Accounts to casinocoin through and offer books to use
    ...
    beast::Journal j)
{
    ...
    if (isDirectCscToCsc<TInAmt, TOutAmt> (strand))
    {
        // The current implementation returns NO_LINE for CSC->CSC transfers.
        // Keep this behavior
...
/**
   ...
   @param baseView Trust lines and balances
   @param strands Each strand contains the steps of accounts to casinocoin through
