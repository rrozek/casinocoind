...
#ifndef CASINOCOIN_APP_PATHS_PATHSTATE_H_INCLUDED
#define CASINOCOIN_APP_PATHS_PATHSTATE_H_INCLUDED

#include <casinocoin/app/paths/Node.h>
#include <casinocoin/app/paths/Types.h>
...
class PathState : public CountedObject <PathState>
{
  public:
    ...
    TER checkNoCasinocoin (AccountID const& destinationAccountID,
