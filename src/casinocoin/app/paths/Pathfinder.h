...
#ifndef CASINOCOIN_APP_PATHS_PATHFINDER_H_INCLUDED
#define CASINOCOIN_APP_PATHS_PATHFINDER_H_INCLUDED
...
/** Calculates payment paths.
    ...
    The @ref CasinocoinCalc determines the quality of the found paths.
...
public:
    ...
    */
    ...
    enum NodeType
    {
        ...
        nt_CSC_BOOK,   // The order book from this currency to CSC.
    ...
    enum PaymentType
    {
        ...
        pt_CSC_to_nonCSC,
        pt_nonCSC_to_CSC,
        pt_nonCSC_to_same,   // Destination currency is the same as source.
        pt_nonCSC_to_nonCSC  // Destination currency is NOT the same as source.
    };
...
private:
    ...
    // set the "no casinocoin" flag on the link?
    bool isNoCasinocoinOut (STPath const& currentPath);

    // Is the "no casinocoin" flag set from one account to another?
    bool isNoCasinocoin (
    ...
    std::shared_ptr<CasinocoinLineCache> mRLCache;
