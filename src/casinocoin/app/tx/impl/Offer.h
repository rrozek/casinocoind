...
#ifndef CASINOCOIN_APP_BOOK_OFFER_H_INCLUDED
#define CASINOCOIN_APP_BOOK_OFFER_H_INCLUDED
...
template<>
inline
void TOffer<IOUAmount, CSCAmount>::setFieldAmounts ()
{
    m_entry->setFieldAmount (sfTakerPays, toSTAmount(m_amounts.in, issIn_));
...
template<>
inline
void TOffer<CSCAmount, IOUAmount>::setFieldAmounts ()
{
