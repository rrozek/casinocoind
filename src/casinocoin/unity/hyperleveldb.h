...
#ifndef CASINOCOIN_UNITY_HYPERLEVELDB_H_INCLUDED
#define CASINOCOIN_UNITY_HYPERLEVELDB_H_INCLUDED

#include <beast/Config.h>

#if ! BEAST_WIN32

#define CASINOCOIN_HYPERLEVELDB_AVAILABLE 1
...
#define CASINOCOIN_HYPERLEVELDB_AVAILABLE 0
