...
#ifndef CASINOCOIN_CORE_JOBQUEUE_H_INCLUDED
#define CASINOCOIN_CORE_JOBQUEUE_H_INCLUDED
...
#include <casinocoin/core/impl/Workers.h>
...
#include <casinocoin/core/Coro.ipp>
