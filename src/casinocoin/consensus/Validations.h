...
#ifndef CASINOCOIN_CONSENSUS_VALIDATIONS_H_INCLUDED
#define CASINOCOIN_CONSENSUS_VALIDATIONS_H_INCLUDED
...
#include <casinocoin/consensus/LedgerTrie.h>
...
struct ValidationParms
{
    ...
    */
    std::chrono::seconds validationCURRENT_WALL = std::chrono::minutes{10};
    ...
    */
    std::chrono::seconds validationCURRENT_LOCAL = std::chrono::minutes{7};

    /** Duration pre-close in which validations are acceptable.
        The number of seconds before a close time that we consider a validation
        acceptable. This protects against extreme clock errors
    */
    std::chrono::seconds validationCURRENT_EARLY = std::chrono::minutes{7};
