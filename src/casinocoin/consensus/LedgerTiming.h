...
#ifndef CASINOCOIN_APP_LEDGER_LEDGERTIMING_H_INCLUDED
#define CASINOCOIN_APP_LEDGER_LEDGERTIMING_H_INCLUDED
...
//! We increase this number from 15 to 120 (2 minutes) to prevent an enormous empty blockchain
//!  if there are little transactions
auto constexpr LEDGER_IDLE_INTERVAL = 120s;
...
*/
auto constexpr VALIDATION_VALID_LOCAL = 2min;
...
*/
auto constexpr VALIDATION_VALID_EARLY = 2min;
...
/** Calculates the close time resolution for the specified ledger.
    ...
    The Casinocoin protocol uses binning to represent time intervals using only one
