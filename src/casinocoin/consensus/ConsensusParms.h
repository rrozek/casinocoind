...
#ifndef CASINOCOIN_CONSENSUS_CONSENSUS_PARMS_H_INCLUDED
#define CASINOCOIN_CONSENSUS_CONSENSUS_PARMS_H_INCLUDED
...
struct ConsensusParms
{
    ...
    */
    ...
    std::chrono::milliseconds ledgerIDLE_INTERVAL = std::chrono::seconds {300};
